...
export function PostCanvas({
  ...
  return (
    <div
      id="post-canvas"
      className="relative aspect-square w-full rounded-lg border-2 border-border p-12 shadow-lg"
      ...
      <div className="flex h-full flex-col gap-6">
          ...
          <div key={section.id} className="group relative">
            ...
            {section.type === "title" && (
              <div
                ...
                className="cursor-text text-balance text-5xl font-bold leading-tight outline-none focus:ring-2 focus:ring-blue-500 flex items-center"
                style={{ 
            ...
            {section.type === "label-box" && (
              <div
                ...
                className="inline-flex items-center cursor-text rounded-md px-6 py-3 text-xl font-bold outline-none focus:ring-2 focus:ring-blue-500"
                style={{
            ...
            {section.type === "text-box" && (
              <div
                ...
                className="cursor-text rounded-lg border-2 p-6 text-lg leading-relaxed outline-none focus:ring-2 focus:ring-blue-500 flex items-center"
                style={{ 
        ...
        <div className="flex items-end justify-between">
          <div
            ...
            className="cursor-text text-2xl font-medium outline-none focus:ring-2 focus:ring-blue-500 flex items-center"
            style={{ 
